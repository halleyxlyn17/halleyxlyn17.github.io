...
dados <- data.frame(
  ...
  Gender_Wage_Gap = c(34.21, 33.66, 35.75, 34.04, 28.58, 15.79, 34.69, 12.5, 32.01, 11.31, 30.88, 33.33, 4.55, 20.58, 18.18, 22.22, 11.78, 26.11, 26.45)
)


graphicss <- ggplot(dados, aes(x = ano, y = valor, color = pais, label = Year-Gap)) +
  geom_point(size = 3) +
  geom_text(size = 3, vjust = -0.5) +
  labs(x = "Year", y = " Gender_Wage_Gap", title = "Scatter Plot 2", color = "País") +
  theme_minimal() +
