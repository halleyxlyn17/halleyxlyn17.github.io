...
Graphs <- ggplot(dados, aes(x = year, y = Wage_Gap, color = country, group = country)) +
  geom_line() +
  geom_point() +
...
graphic_final <- Graphs +
  geom_text(data = subset(dados, year %in% unique(year)), aes(label = Wage_Gap), hjust = 0, vjust = -0.5, size = 3)
